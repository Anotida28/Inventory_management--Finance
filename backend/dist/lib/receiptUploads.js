...
exports.removeUploadedReceiptFiles = exports.mapUploadedReceiptFiles = exports.runReceiptAttachmentUpload = void 0;
...
const configuredUploadPath = process.env.RECEIPT_UPLOAD_PATH || "./data/uploads/receipts";
...
const runReceiptAttachmentUpload = (req, res, next) => {
...
exports.runReceiptAttachmentUpload = runReceiptAttachmentUpload;
const mapUploadedReceiptFiles = (files) => {
...
exports.mapUploadedReceiptFiles = mapUploadedReceiptFiles;
const removeUploadedReceiptFiles = (files) => {
    files.forEach((file) => {
...
exports.removeUploadedReceiptFiles = removeUploadedReceiptFiles;
