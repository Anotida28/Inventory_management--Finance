...
const ensureExtendedReceivingSchema = () => {
  ...
  assertSchemaReady("Receiving", [
    {
      tableName: "stock_locations",
      requiredColumns: ["locationId", "locationName"],
    },
    {
      tableName: "receiving_receipt_lines",
      requiredColumns: [
        "lineId",
        "receiptId",
        "lineNumber",
...
export const reconcileReceivingReceiptDocumentStates = () => {
